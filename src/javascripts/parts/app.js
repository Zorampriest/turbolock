...
$(".turbolock-menu").click(function () {
    $(".turbolock-mobmenu").css("display", "block");
    $(".turbolock-menu").css("display", "none");
	$("html,body").css("overflow", "hidden");
	$(".turbolock-header").css("position", "fixed");
	
});

$(".turbolock-close").click(function () {
    $(".turbolock-mobmenu").css("display", "none");
    $(".turbolock-menu").css("display", "block");
    $("html,body").css("overflow", "auto");
    $(".turbolock-header").css("position", "");
